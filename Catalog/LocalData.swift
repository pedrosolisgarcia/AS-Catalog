...
public class LocalData {
    ...
    static func getDresses() -> [Dress] {
        let dresses = [
            Dress(name: ["Crystal"], imgName: "Crystal", isSelected: false),
            Dress(name: ["Amber"], imgName: "Amber", isSelected: false),
            Dress(name: ["Fernanda"], imgName: "Fernanda", isSelected: false),
            Dress(name: ["Fernanda z Trenem","Fernanda with Train","Fernanda con Tren"],
                  imgName: "Fernanda Z Trenem", isSelected: false),
            Dress(name: ["Stella"], imgName: "Stella", isSelected: false),
            Dress(name: ["Clara"], imgName: "Clara", isSelected: false),
            Dress(name: ["Candy"], imgName: "Candy", isSelected: false),
            Dress(name: ["Charlotte"], imgName: "Charlotte", isSelected: false),
            Dress(name: ["Clementina"], imgName: "Clementina", isSelected: false),
            Dress(name: ["Daisy"], imgName: "Daisy", isSelected: false),
            Dress(name: ["Mirabella"], imgName: "Mirabella", isSelected: false),
            Dress(name: ["Delfina"], imgName: "Delfina", isSelected: false),
            Dress(name: ["Diva"], imgName: "Diva", isSelected: false),
            Dress(name: ["Diva Z Trenem","Diva with Train","Diva con Tren"],
                  imgName: "Diva Z Trenem", isSelected: false),
            Dress(name: ["Diva z Peleryną","Diva with Cape","Diva con Capa"],
                  imgName: "Diva Z Peleryna", isSelected: false),
            Dress(name: ["Mafalda"], imgName: "Mafalda", isSelected: false),
            Dress(name: ["Rita"], imgName: "Rita", isSelected: false),
            Dress(name: ["Rita z Trenem","Rita with Train","Rita con Tren"],
                  imgName: "Rita Z Trenem", isSelected: false),
            Dress(name: ["Tamara"], imgName: "Tamara", isSelected: false),
            Dress(name: ["Laguna"], imgName: "Laguna", isSelected: false),
            Dress(name: ["Samira"], imgName: "Samira", isSelected: false),      
            Dress(name: ["Rosalia"], imgName: "Rosalia", isSelected: false),
            Dress(name: ["Flora"], imgName: "Flora", isSelected: false),
            Dress(name: ["Flora z Trenem","Flora with Train","Flora con Tren"],
                  imgName: "Flora Z Trenem", isSelected: false),
            Dress(name: ["Estela"], imgName: "Estela", isSelected: false),
            Dress(name: ["Loretta"], imgName: "Loretta", isSelected: false),
            Dress(name: ["Florence"], imgName: "Florence", isSelected: false),
            Dress(name: ["Perla"], imgName: "Perla", isSelected: false),
            Dress(name: ["Ariana"], imgName: "Ariana", isSelected: false),
            Dress(name: ["Ariana z Trenem","Ariana with Train","Ariana con Tren"],
                  imgName: "Ariana Z Trenem", isSelected: false),
            Dress(name: ["Valeria"], imgName: "Valeria", isSelected: false),
            Dress(name: ["Valeria z Trenem","Valeria with Train","Valeria con Tren"],
                  imgName: "Valeria Z Trenem", isSelected: false),
            Dress(name: ["Yasmin"], imgName: "Yasmin", isSelected: false),
            Dress(name: ["Isadora"], imgName: "Isadora", isSelected: false)
        ]
        return dresses
    }
